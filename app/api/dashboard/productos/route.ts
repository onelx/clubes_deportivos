...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { club_id, nombre, descripcion, precio_base, precio_comparacion, personalizable, imagen_personalizacion, costo_produccion, categoria, imagenes, variantes } = body;
    ...
    const insertPayload: Record<string, unknown> = {
      ...
      imagen_personalizacion: imagen_personalizacion ?? null,
